...
<h2>Admin setings</h2>
<div class="btn-group">
<a href="a_s.php">		<button type="submit" class="btn-3" name="ubaci"><i class='fa fa-fw fa-paper-plane'></i> Add</button></a>
</div>
</div>
<br>
<?php
...
<th>Action:</th>
<td>
<a href="ad_se.php?id=<?php echo $row['id']; ?>"><button type="submit" class="btn-6" name="azuriraj"><i class='fa fa-fw fa-save'></i> Edit</button></a>
<a href=d_as.php?id=<?php echo $row['id']; ?>><button type="submit" class="btn-5" name="azuriraj"><i class='fa fa-fw fa-trash'></i> Delete</button></a>
