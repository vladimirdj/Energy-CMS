...
$sqlSetup = mysqli_query($conection, "SELECT * FROM admin_setings");
...
while($row = mysqli_fetch_array($sqlSetup)){
 ...
 $logo = $row["logo"];
      ...
      if(isset($_POST['edit'])) {
       ...
       $header = $_POST["header"];
       $logo = $_POST["logo"];
      $result = mysqli_query($conection, "UPDATE admin_setings SET title='$title',description='$description',footer='$footer',header='$header',logo='$logo' WHERE id=$id");
