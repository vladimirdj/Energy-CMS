...
<h2>Site setings</h2>
<div class="btn-group">
<a href="a_ss.php">		<button type="submit" class="btn-3" name="ubaci"><i class='fa fa-fw fa-paper-plane'></i> Add</button></a>
</div>
</div>
<br>
<?php
...
<th>Action:</th>
<td>
<a href="ad_ss.php?id=<?php echo $row['id']; ?>"><button type="submit" class="btn-6" name="azuriraj"><i class='fa fa-fw fa-save'></i> Edit</button></a>
<a href=d_ss.php?id=<?php echo $row['id']; ?>><button type="submit" class="btn-5" name="azuriraj"><i class='fa fa-fw fa-trash'></i> Delete</button></a>
