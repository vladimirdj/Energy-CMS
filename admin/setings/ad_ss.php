...
$sqlSetup = mysqli_query($conection, "SELECT * FROM site_setings");

while($row = mysqli_fetch_array($sqlSetup)){
$id = $row['id'];
$title = $row["title"];
...
$result = mysqli_query($conection, "UPDATE site_setings SET title='$title',description='$description',footer='$footer',header='$header',logo='$logo', keywords='$keywords', analytic='$analytic', seo='$seo' WHERE id=$id");
echo "<p class='bg-success'>Uspesno uradjeno azuriranje!Povratak</p>";
...
<label>Title</label>
<input class="form-input" name="title" value="<?php echo $title; ?>" placeholder="My Portfolio Site">
</div>

<div class="form-group">
<label>Description</label>
<textarea class="form-input" name="description" rows="3"><?php echo $description; ?></textarea>
</div>
<div class="form-group">
<label>Footer</label>
<input class="form-input" name="footer" value="<?php echo $footer; ?>">
</div>
<div class="form-group">
<label>Header</label>
<input class="form-input" name="header" value="<?php echo $header; ?>">
</div>
<div class="form-group">
<label>logo</label>
<input class="form-input" name="logo" value="<?php echo $logo; ?>">
</div>
<div class="form-group">
<label>Keywords</label>
<textarea class="form-input" name="keywords" rows="3"><?php echo $keywords; ?></textarea>
</div>
<div class="form-group">
<label>Analytic</label>
<input class="form-input" name="analytic"  value="<?php echo $analytic; ?>">
</div>
<div class="form-group">
<label>Seo</label>
<textarea class="form-input" name="seo" rows="3"><?php echo $seo; ?></textarea>
</div>
<br>
<div class="btn-group">

<button type="submit" class="btn-2" name="edit"></i> Edit</button>
