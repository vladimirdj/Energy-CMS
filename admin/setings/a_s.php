...
$query = "INSERT INTO admin_setings (title, user,	description, header, footer, logo)
VALUES('{$title}', '{$_SESSION["user"]}','{$description}','{$header}','{$footer}','{$logo}')";
