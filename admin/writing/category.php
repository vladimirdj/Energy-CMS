...
<br>
<div align="center">
<a href="a_c.php"><button class="btn-5">Add category</button></a>
</div>
<div class="card">
...
<td data-title="cat_title"><?php echo $user; ?></td>
<td data-title="cat_title"><?php echo $cat_title; ?></td>
<td data-title="date"><?php echo $date; ?></td>
<td><a href="v_c.php?cat_id=<?php echo $cat_id; ?>"><button class="btn-1">View</button></a>
<a href="e_c.php?cat_id=<?php echo $cat_id; ?>"><button class="btn-2">Edit</button></a>
<a href="d_c.php?cat_id=<?php echo $cat_id; ?>" onClick="return confirm('Delete ?')\"><button class="btn-5">Delete</button></a></td>
</tr>
<?php
