...
$result = mysqli_query($conection, "UPDATE category SET cat_title='$cat_title' WHERE cat_id=$cat_id");
...
<label for="cat_title"><h2>Cat title</h2></label>
<input type="text" name="cat_title" class="form-input" value="<?php echo $cat_title; ?>">
</div>
<div class="form-group">
