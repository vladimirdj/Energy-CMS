...
$sql = mysqli_query($conection, "SELECT * FROM menu ORDER BY id DESC");
...
<td data-title="url"><?php echo $url; ?></td>
<td><a href="e_m.php?id=<?php echo $id; ?>"><button class="btn-2">Edit</button></a><a href="d_m.php?id=<?php echo $id; ?>" onClick=\"return confirm('Delete?')\"><button class="btn-5">Delete</button></a></td>
...
?>
<td data-title="id"><?php echo $parent_id; ?></td>
<td data-title="title"><?php echo $title; ?></td>
<td data-title="user"><?php echo $user; ?></td>
<td data-title="url"><?php echo $url; ?></td>
<td data-title="parent"><?php echo $s_id; ?></td>

<td><a href="e_sm.php?parent_id=<?php echo $parent_id; ?>"><button class="btn-2">Edit</button></a><a href="d_sm.php?parent_id=<?php echo $parent_id; ?>" onClick=\"return confirm('Delete?')\"><button class="btn-5">Delete</button></a><br></td>
