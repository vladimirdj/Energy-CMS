...
$upit= "SELECT * FROM pages WHERE st_id='$st_id'";
...
?>
<tr>
<td data-title="st_id"><?php echo $st_id; ?></td>
...
<td data-title="url"><a href="../../test_s.php?st_id=<?php echo $st_id; ?>"><?php echo $title; ?></a></td>
