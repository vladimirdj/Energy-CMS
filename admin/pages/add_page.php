...
<ul class="se1">
<li>  <a href="../users/user.php" class="link">Users &#8657;</a></li>
...
<form method="POST" action="a_p.php" enctype="multipart/form-data">

<div class="form-group">
<label for="title"><center><h2>Title</h2></center></label>
...
<label for="title"><center><h2>Subject</h2></center></label>
<textarea id="subject"  name="subject" cols="90" rows="20" class="form-input"></textarea>
</div>
</div>
...
<div align="center">
<div class="btn-group">
<button type="submit" name="ubaci" id="mybutton" class="btn-3" >POST</button>
