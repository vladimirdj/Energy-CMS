...
<ul class="se1">
<li>  <a href="index.php" class="link">Pages &#8657;</a></li>
...
<tr>
<td data-title="id"><?php echo $st_id; ?></td>
...
<td><a href="v_p.php?st_id=<?php echo $st_id; ?>"><button class="btn-1">View</button></a><a href="e_p.php?st_id=<?php echo $st_id; ?>"><button class="btn-2">Edit</button></a><a href="d_p.php?st_id=<?php echo $st_id; ?>" onClick=\"return confirm('Zelis da obrises?')\"><button class="btn-5">Delite</button></a>
