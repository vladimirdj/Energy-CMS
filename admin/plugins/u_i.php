...
<label for="thread_title1">File</label>
<input type="file" name="my_file" class="form-input">
</div>

<input type="hidden" name="name" value=<?php echo $_GET['name'];?>>
<div class="btn-group">
<input type="submit" name="upload_button" class="btn-2" value="Upload">
