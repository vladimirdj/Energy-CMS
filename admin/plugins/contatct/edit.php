...
$result = mysqli_query($conection, "UPDATE contact SET user='$user', subject='$subject',	title='$title',email='$email' WHERE e_id=$e_id");
...
<div class="form-group">
<label for="thread_title"><h2>Title</h2></label>
...
<div class="form-group">
<label for="thread_title"><h2>Subject</h2></label>
