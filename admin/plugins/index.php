...
<ul class="se1">
<li>  <a href="index.php" class="link">View plugins &#8657;</a></li>
...
<td data-title="position"><?php echo $position; ?></td>
<td data-title="function"><?php echo $function; ?></td>
<td data-title="date"><?php echo $date; ?></td>

<td><a href="view.php?title=<?php echo $title; ?>"><button class="btn-1">View</button></a><a href="edit.php?id=<?php echo $id; ?>"><button class="btn-2">Edit</button></a><a href="obrisi.php?id=<?php echo $id; ?>" onClick=\"return confirm('Zelis da obrises?')\"><button class="btn-5">Delite</button></a>
...
<td data-title="view"> <a href="v_i.php?name=<?php echo $name; ?>"><button class="btn-2">View</button></a></td>
<td data-title="edit"> <a href="e_i.php?name=<?php echo $name; ?>"><button class="btn-2">Edit</button></a></td>
<td data-title="upload"> <a href="u_i.php?name=<?php echo $name; ?>"><button class="btn-2" name="upload" data-name="<?php echo $name; ?>">Upload</button></a></td>
