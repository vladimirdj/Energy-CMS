...
$js = $_POST['js'];
$result = mysqli_query($conection, "UPDATE theme SET title='$title',css='$css',js='$js' WHERE t_id=$t_id");
...
$result = mysqli_query($conection, "SELECT * FROM theme WHERE t_id = $t_id");
...
<input type="text" class="form-input" name="css" value="<?php echo $css; ?>"> <br>
</div>
<div class="form-group">
<label for="js">JS</label>
<input type="text" class="form-input" name="js" value="<?php echo $js; ?>"> <br>
</div>
<input type="hidden" name="t_id" value=<?php echo $_GET['t_id'];?>></td>
<div class="btn-group">
<input type="submit" name="update" class="btn-3" value="Update"></td>
